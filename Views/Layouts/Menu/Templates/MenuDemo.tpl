...
<div class="hero_area">
    <div class="hero_bg_box" style="background: white;">
        <img src='http://dev.bbincovatio.com/Views/Layouts/Menu/Styles/demo/images/hero-bg.png' alt="">
    </div>
        ...
        <div id="customCarousel1" class="carousel slide" data-interval="false">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="row">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                La excelencia médica y la seguridad del paciente son fundamentales para todo lo que hacemos.
                            </p>
                            <div class="btn-box 0">
                            <a  class="btn1">
                                Institución
                ...
                <div class="carousel-item">
                    ...
                    <div class="row">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Nos enorgullecemos de contar con instalaciones de última generación y tecnología avanzada. 
                            </p>
                            <div class="btn-box 2">
                            <a href="" class="btn1">
                                Paquetes
