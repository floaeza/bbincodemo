...
pak = requests.post('http://10.0.3.9/BBINCO/TV_PRUEBAS/Core/Controllers/PY.php', data=payload)
...
for pos in range(len(listDays)):
    ...
    req = requests.post('http://10.0.3.9/BBINCO/TV_PRUEBAS/Core/Controllers/Packages.php', data=info)
