...
pak = requests.post('http://10.30.0.15/BBINCO/TV/Core/Controllers/PY.php', data=payload)
...
for pos in range(len(listDays)):
    ...
    req = requests.post('http://10.30.0.15/BBINCO/TV/Core/Controllers/Packages.php', data=info)
