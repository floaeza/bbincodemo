...
with open("/var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers/logInformir.txt", "r") as f:
    lines = f.readlines()
f.close()
...
try:
    file = open("/var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers/logInformir.txt", "w")
