...
cred = credentials.Certificate('/var/www/html/BBINCO/TV2/Views/Scripts/FireBase/serviceAccountKey.json')
...
for i in range(1,100):
    try:
        with open('/var/www/html/BBINCO/TV2/Core/Controllers/Epg/'+identificador+'/epg_'+fechajson+'_'+str(i)+'.json') as file:
    ...
    for change in changes:
        if change.type.name == 'ADDED':
            ...
            if stb['status'] == 'pending':
                ...
                var = requests.post('http://localhost/BBINCO/TV2/Core/Controllers/Firebase.php', data=payload)
                #requests.post('http://bbinco.fortiddns.com:669/BBINCO/TV2/Core/Controllers/Firebase.php', data=payload)
