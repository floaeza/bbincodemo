...
cred = credentials.Certificate('/var/www/html/BBINCO/TVCH/Views/Scripts/FireBase/serviceAccountKey.json')
...
#Identifier = requests.post('http://bbinco.fortiddns.com:669/BBINCO/TVCH/Core/Controllers/PY.php', data=payload)
...
for i in range(1,100):
    try:
        with open('/var/www/html/BBINCO/TVCH/Core/Controllers/Epg/'+identificador+'/epg_'+fechajson+'_'+str(i)+'.json') as file:
    ...
    for change in changes:
        if change.type.name == 'ADDED':
            ...
            if stb['status'] == 'pending':
                ...
                var = requests.post('http://10.0.3.241/BBINCO/TVCH/Core/Controllers/Firebase.php', data=payload)
                #requests.post('http://bbinco.fortiddns.com:669/BBINCO/TVCH/Core/Controllers/Firebase.php', data=payload)
