...
import json
import requests
with open("/var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers/locaciones.txt", "r") as f:
    lines = f.readlines()
f.close()
...
for locaciones in lines:
    ...
    loc = requests.post('http://10.30.0.15/BBINCO/TV_PRUEBAS/Core/Controllers/Location.php', data=payload)
