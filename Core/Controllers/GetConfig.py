...
import json
import requests
with open("/var/www/html/BBINCO/TVCHL/Core/Controllers/locaciones.txt", "r") as f:
    lines = f.readlines()
f.close()
...
for locaciones in lines:
    ...
    loc = requests.post('http://10.0.3.241/BBINCO/TVCHL/Core/Controllers/Location.php', data=payload)
