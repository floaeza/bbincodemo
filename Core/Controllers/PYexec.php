 ...
 */
    ...
    switch ($Option){
        ...
        case 'UpdateGuide':
            ...
            // $gestor = popen('cd /var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers && python3 DebugTr.py', 'r');
            ...
            // $your_command = 'cd /var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers && python3 DebugTr.py';
