...
for n in range(10):
    ...
    for archivo in files:
        if ('epg_'+DaysToDelete.strftime('%Y%m%d')+'_') in archivo:
            os.remove('/var/www/html/BBINCO/TV2/Core/Controllers/Epg/'+IDF['IDF']+'/'+archivo)
            print(archivo)
        else:
            break
...
Pack = requests.post('http://localhost/BBINCO/TV2/Core/Controllers/Packages.php', data=payload)
