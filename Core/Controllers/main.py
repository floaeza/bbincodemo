...
Identifier = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/PY.php', data=payload)
...
Pack = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/Packages.php', data=payload)
...
def start(day, pos):
    ...
    Version = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/PY.php', data=payload)
    Ver = json.loads(Version.content)
    Ver = Ver[0]
    
    payload = {'Option': 'GetOffsetZone'}
    Zone = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/PY.php', data=payload)
    OffSetZone = json.loads(Zone.content)
    OffSetZone = OffSetZone[0]

    payload = {'Option': 'GetGatoTime'}
    GTime = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/PY.php', data=payload)
    ...
    for Package in Packages:
        ...
        x = requests.post('http://10.110.0.111/BBINCO/TV/Core/Controllers/PY.php', data=payload)
