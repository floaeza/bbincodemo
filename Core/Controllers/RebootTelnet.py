...
Devices = requests.post('http://localhost/BBINCO/TV2/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://localhost/BBINCO/TV2/Core/Controllers/DevicesStatus.php', data=info)            
    except:
