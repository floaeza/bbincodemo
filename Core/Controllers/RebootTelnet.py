...
Devices = requests.post('http://10.0.3.241/BBINCO/TVCHL/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://10.0.3.241/BBINCO/TVCHL/Core/Controllers/DevicesStatus.php', data=info)            
    except:
