...
Devices = requests.post('http://10.0.3.10/BBINCO/TV3/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://10.0.3.10/BBINCO/TV3/Core/Controllers/DevicesStatus.php', data=info)            
    except:
