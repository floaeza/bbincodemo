...
Devices = requests.post('http://10.30.0.15/BBINCO/TV_PRUEBAS/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://10.30.0.15/BBINCO/TV_PRUEBAS/Core/Controllers/DevicesStatus.php', data=info)            
    except:
