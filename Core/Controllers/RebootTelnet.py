...
Devices = requests.post('http://10.0.3.9/BBINCO/TV_PRUEBAS/Core/Controllers/DevicesStatus.php', data=payload)
...
for ips in IDF:
    ...
    try:
        ...
        req = requests.post('http://10.0.3.9/BBINCO/TV_PRUEBAS/Core/Controllers/DevicesStatus.php', data=info)            
    except:
