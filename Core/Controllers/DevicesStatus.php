...
switch ($Option){
    case 'GetDevicesByStatus':
        ...
        case 'RebootDevices':
            ...
            // $command = escapeshellcmd('/var/www/html/BBINCO/TVCHL/Core/Controllers/RebootTelnet.py');
            // $output = shell_exec($command);
            // $Result = $output;
            // $Response = $Result;

            // $gestor = popen('cd /var/www/html/BBINCO/TVCHL/Core/Controllers && python3 RebootTelnet.py', 'r');
