    ...
    case 'GetDevicesByStatus':
        ...
        case 'RebootDevices':
            ...
            $PackagesData->updateParameterReboot($NewPackage);
             //$resultado = shell_exec('cd /var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers && python3 DebugTr.py');  
            // $command = escapeshellcmd('/var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers/RebootTelnet.py');
            // $output = shell_exec($command);
            // $Result = $output;
            // $Response = $Result;

            // $gestor = popen('cd /var/www/html/BBINCO/TV_PRUEBAS/Core/Controllers && python3 RebootTelnet.py', 'r');
