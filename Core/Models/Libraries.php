...
if($GetJson == true || $GetJson == "true"){
    ...
    $JsonLibraries['EpgLogo'] = 'BBINCO/TVCH/Media/Logos/'.$Client.$EpgLogo;
}
...
$JsonLibraries['ServerSource']      = 'http://'.$ServerIp.'/BBINCO/TVCH/';
...
$ServerSource = 'http://'.$ServerIp.'/BBINCO/TVCH/';
